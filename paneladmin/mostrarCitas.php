                                        ...
                                        <td class="text-center">
                                            ...
                                            <?php } elseif (mysql_num_rows($query_) > 0) {
                                                ...
                                                <button class="btn btn-xs btn-info"
                                                        onclick="var id = '<?php echo $admi[$e]['id_cita']; ?>';
                                                            ...
                                                            verReparacion(id, nombre, servicio, fecha, descripcion, cantidad, valor, reparacion)"
                                                        data-toggle="modal" data-target="#verReparacion">
                                                    Ver reparación
                                                </button>
                                            <?php } ?>
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            ...
                                            if (mysql_num_rows($sql) > 0) {
                                                ?>
                                                <a href="../<?php echo $admin->Imagen();?>" style="margin:0px auto"
                                                   class="imagen" title="Transferencia Bancaria">
                                                    <img src="../<?php echo $admin->Imagen();?>"
                                                         class="img-responsive img-rounded" width="30" height="30"
                                                         style="margin:0px auto"/>
                                                    <input type="hidden" id="<?php echo $ad[$i]['id_usuario']?>IMG"
                                                           value="<?php echo MostrarDatosImagen('imagen');?>"/>
                                                </a>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control" disabled="disabled" id="reparacion"
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="form-group">
                        ...
                        <textarea name="comentarioReparacion" rows="4" placeholder="Escriba la reparacion"
                                  id="text-area-reparacion" class="form-control"></textarea>
